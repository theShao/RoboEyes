...
public class LCPMessage {
	...
	public static final int SENSOR_TYPE_NONE = 0x00;
    public static final int SENSOR_TYPE_TOUCH = 0x01;
    public static final int SENSOR_TYPE_ULTRASONIC = 0x03;

    public static final int SENSOR_MODE_RAW = 0x00;
    public static final int SENSOR_MODE_BOLEAN = 0x01;
    ...
    public static byte[] getSetInputModeMessage(int port, int sensorType, int sensorMode) {
